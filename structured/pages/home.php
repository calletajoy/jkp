        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <a href="/services"><h4 class="card-title"><?php echo $card['title']; ?></h4></a>
        ...
        <div class="row align-items-center py-4">
            <div class="col-12 col-lg-5" data-aos="fade-up">
                <div class="images">
                    ...
                    <img class="img-fluid img-tow left-slider" src="/assets/images/placeholders/brianna-parks-WQW0uTofZiE-unsplash.jpg" alt="Coastal Counties">
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            ...
            <div class="col" data-aos="fade-up">
                <div class="card h-100 border-0 rounded-0">
                    ...
                    <div class="card-body">
                        <a href="/services"><h4 class="card-title"><?php echo $project['title']; ?></h4></a>
            ...
            <div class="city-service-list">
                <div class="row city-footer-content">
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-right">
                        <ul>
                            <li class="hove"><a href="/about" target="_blank" rel="noopener noreferrer"><span>Mission: Catalyze economic growth of Kenya's coast regional counties</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Social Innovation Network for Workforce &amp; MSMEs</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Youth &amp; Women Empowerment in the Coast Region</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>High Middle-Income Population Transformation Goal</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>County Integrated Development Plans (CIDPs) Alignment</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Vision 2030 Medium Term Plans (MTP) Integration</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                        </ul>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-down">
                        <ul>
                            <li class="hove"><a href="/about" target="_blank" rel="noopener noreferrer"><span>Socio-Political &amp; Regional Policy Harmonization</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Promoting Regional Tourism, Culture &amp; Heritage</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Facilitating Investor &amp; Development Partner Engagement</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Supporting Public-Private Partnerships for Investments</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>JABEIC Annual Conference — Flagship Investment Event</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Reducing Poverty &amp; Stimulating Socio-Economic Transformation</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                        </ul>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-left">
                        <ul>
                            <li class="hove"><a href="/about" target="_blank" rel="noopener noreferrer"><span>Jumuiya 10 Pillars Program Implementation</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Regional Flagship Projects — High-Impact Execution</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Showcasing Investment Opportunities at JABEIC</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Knowledge Exchange for High-Growth Coastal Sectors</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Coordinating Six County Governments via the Secretariat</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                            <li><a href="/about" target="_blank" rel="noopener noreferrer"><span>Bilateral Relations &amp; International Development Partnerships</span><i class="bi bi-chevron-right float-end me-2"></i></a><div class="divide-row"></div></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100 border-0 rounded" data-aos="fade-right">
                    ...
                    <div class="card-body p-3">
                        ...
                        <a href="/blog"><h3 class="card-title"><?php echo htmlspecialchars($item['title']); ?></h3></a>
                    </div>
