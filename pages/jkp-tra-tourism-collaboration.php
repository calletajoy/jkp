<?php
/**
 * pages/jkp-tra-tourism-collaboration.php
 * JKP and TRA strengthen collaboration on sustainable tourism
 */

$pageTitle    = 'JKP and TRA ';
$currentPage  = 'news';
$heroTitle    = 'JKP and TRA ';
$heroSubtitle = 'Courtesy Meeting with Tourism Regulatory Authority';

// Add Open Graph and Twitter Card meta tags for social sharing
$ogImage = 'https://dev.jumuiya.org/assets/images/TRA (2).png';
$ogDescription = 'Jumuiya Economic Development Secretariat held a courtesy meeting with the Tourism Regulatory Authority (TRA) to strengthen collaboration on sustainable tourism along the Coastal region.';
$ogUrl = 'https://dev.jumuiya.org/jkp-tra-tourism-collaboration';
        ...
        <div class="row">
            ...
            <div class="col-lg-8 article-main">
                ...
                <div class="category-tag" data-aos="fade-up">
                    <a href="/news-updates?subcategory=Tourism" class="category-badge">
                        <i class="bi bi-tag"></i> Tourism
                    </a>
                </div>

                <!-- Article Header -->
                <header class="article-header" data-aos="fade-up">
                    <h1>JKP and TRA strengthen collaboration on sustainable tourism</h1>
                    <div class="article-meta">
                        <span><i class="bi bi-calendar3"></i> March 6, 2026</span>
                ...
                <div class="featured-image" data-aos="fade-up" data-aos-delay="50">
                    <img src="/assets/images/TRA (2).png" alt="JKP and TRA meeting on Beach Management Standards">
                </div>
                ...
                <div class="article-content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="location-card">
                        ...
                        <div class="location-details">
                            ...
                            <p>Courtesy Meeting between JKP and TRA</p>
                        </div>
                    </div>
                    
                    <p class="lead">Jumuiya Economic Development Secretariat held a courtesy meeting with the Tourism Regulatory Authority (TRA) to strengthen collaboration on sustainable tourism along the Coastal region.</p>
                    
                    <p>During the meeting, TRA presented on the development of a Beach Management Standard, an initiative aimed at improving beach governance, enhancing visitor experience, promoting environmental conservation, and supporting the local coastal economy.</p>
                    
                    <p>JKP welcomed the initiative and reiterated its commitment to working with stakeholders to ensure that coastal counties benefit from well-managed, safe, and globally competitive beach destinations.</p>
                    
                    <div class="quote-box">
                        <i class="bi bi-chat-quote"></i>
                        <p>We continued our consultations with Jumuiya ya Kaunti za Pwani through a productive meeting on Beach Management Standards. The discussions centered on strengthening collaboration and advancing the development of standards that will promote sustainable and responsible beach management along our coast.</p>
                    </div>
                </div>
                ...
                <div class="sidebar-widget" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="prev-news-item">
                        ...
                        <div class="prev-news-info">
                            <h6>EAWLS trains coastal stakeholders on Blue Carbon policy and advocacy</h6>
