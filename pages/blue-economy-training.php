<?php
/**
 * pages/blue-economy-training.php
 * Blue Economy Vocational Training Program Article Page
 */

$pageTitle    = 'Blue Economy vocational training program';
$currentPage  = 'news';
$heroTitle    = 'Blue Economy Training';
        ...
        <div class="row">
            ...
            <div class="col-lg-8 article-main">
                ...
                <header class="article-header" data-aos="fade-up">
                    <h1>Blue Economy vocational training program</h1>
                    <div class="article-meta">
                        <span><i class="bi bi-calendar3"></i> May 20, 2024</span>
                ...
                <div class="featured-image" data-aos="fade-up" data-aos-delay="50">
                    <img src="/assets/images/ecoblue.png" alt="Blue Economy vocational training program">
                </div>

                <!-- Secondary Image -->
                <div class="secondary-image" data-aos="fade-up" data-aos-delay="75">
                    <img src="/assets/images/ecoblue.png" alt="Blue Economy Training Session">
                </div>

                <!-- Article Content -->
                <div class="article-content" data-aos="fade-up" data-aos-delay="100">
                    <p class="lead">Jumuiya's Go Blue Project team is happy to share the success story of our Blue Economy vocational training program in the JKP region! With the support of the Delegation of the European Union to Kenya, implementation by GIZ Kenya, and technical expertise from CAP YEI, we've developed 5 CBET curricula: Hotel & Hospitality, Maritime Transport & Logistics, Maritime Security, and equipped the 6 Vocational Training Centers with digital e-learning platforms and an MSME lab.</p>
                    
                    <!-- Stats Highlight -->
                    <div class="stats-highlight">
                        <div class="stat-item">
                            <div class="stat-number">5</div>
                            <div class="stat-label">CBET Curricula</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number">6</div>
                            <div class="stat-label">VTCs Equipped</div>
                        </div>
                        <div class="stat-item">
                    ...
                    <p>After the exit of GIZ's support in December 2023, Kisauni VTC has continued to offer the courses without the support of the project, an indication of sustainability at its best!</p>
                    
                    <p>This is a testament to the sustainability and impact of the Go Blue program. Kisauni VTC delivered batch 5 of 303 learners, batch 6 of 233 learners, and batch 7 of 234 learners using their own internal resources. They have now advertised for batch 8 in this poster!</p>
                </div>

                <!-- Poster Section -->
                <div class="poster-section" data-aos="fade-up">
                    <h3>Batch 8 Enrollment Now Open!</h3>
                    <p>Kisauni VTC is now accepting applications for Batch 8 of the Blue Economy vocational training program. Find all the details in the poster below.</p>
                    <a href="#" class="poster-link" target="_blank">
                        <i class="bi bi-file-earmark-post"></i> View Poster
                    </a>
                </div>
