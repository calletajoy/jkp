<?php
/**
 * pages/jkp-agricultural-summit.php
 * JKP Agricultural Revitalization Summit kicks off in Malindi
 */

$pageTitle    = 'Revitalization Summit ';
$currentPage  = 'news';
$heroTitle    = 'Revitalization Summit';
$heroSubtitle = 'Ocean Beach Hotel, Malindi';

// Add Open Graph and Twitter Card meta tags for social sharing
$ogImage = 'https://dev.jumuiya.org/assets/images/revt-sumit (1).png';
$ogDescription = 'The Jumuiya ya Kaunti za Pwani Agricultural Revitalization Summit commenced at Ocean Beach Hotel, Malindi, officiated by Hon. Mutahi Kagwe, Cabinet Secretary of Agriculture and Livestock.';
$ogUrl = 'https://dev.jumuiya.org/jkp-agricultural-summit';
        ...
        <div class="row">
            ...
            <div class="col-lg-8 article-main">
                ...
                <div class="category-tag" data-aos="fade-up">
                    <a href="/news-updates?subcategory=Investment" class="category-badge">
                        <i class="bi bi-tag"></i> Investment
                    </a>
                </div>

                <!-- Article Header -->
                <header class="article-header" data-aos="fade-up">
                    <h1>JKP Agricultural Revitalization Summit kicks off in Malindi</h1>
                ...
                <div class="featured-image" data-aos="fade-up" data-aos-delay="50">
                    <img src="/assets/images/revt-sumit (1).png" alt="JKP Agricultural Revitalization Summit in Malindi">
                </div>
                ...
                <div class="article-content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="location-card">
                        ...
                        <div class="location-details">
                            <h4>Ocean Beach Hotel, Malindi</h4>
                            <p>JKP Agricultural Revitalization Summit</p>
                        </div>
                    </div>
                    
                    <p class="lead">The Jumuiya ya Kaunti za Pwani Agricultural Revitalization Summit commenced at Ocean Beach Hotel, Malindi. This milestone event was officiated by Hon. Mutahi Kagwe, Cabinet Secretary of Agriculture and Livestock and organized by the Agriculture Food Authority.</p>
                    
                    <p>The summit brought together the JKP Governors, Government Agency stakeholders, Agriculture experts, development partners and private sector.</p>
                    
                    <p>The discussions were very vibrant in bringing forward critical issues aimed at advancing agricultural interventions in the region. Discussions centered around promotion of Climate Smart Agriculture, Value Addition and how National Government and County Governments can work together to deepen regional collaboration.</p>
                    ...
                    <div class="focus-grid">
                        <div class="focus-card">
                            ...
                            <p>Sustainable farming practices that increase productivity and build resilience to climate change</p>
                        </div>
                        <div class="focus-card">
                            <div class="focus-icon">
                            ...
                            <p>Processing and packaging agricultural products to increase market value and farmer incomes</p>
                        </div>
                        <div class="focus-card">
                            <div class="focus-icon">
                                <i class="bi bi-people"></i>
                            </div>
                            <h4>Regional Collaboration</h4>
                            <p>Strengthening partnership between National and County Governments for agricultural transformation</p>
                        </div>
                    </div>
                    
                    <p>The summit marks a significant step towards growth of the agricultural sector and ensuring the coastal region makes action-driven steps to realize the great potential that it possesses in agriculture and agribusiness.</p>
                </div>
