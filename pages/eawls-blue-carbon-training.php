<?php
/**
 * pages/eawls-blue-carbon-training.php
 * EAWLS trains coastal stakeholders on Blue Carbon policy and advocacy
 */

$pageTitle    = 'EAWLS';
$currentPage  = 'news';
$heroTitle    = 'EAWLS';
$heroSubtitle = 'Two-day Policy and Advocacy Training in Mombasa';

// Add Open Graph and Twitter Card meta tags for social sharing
$ogImage = 'https://dev.jumuiya.org/assets/images/EAWLS (4).png';
$ogDescription = 'The East African Wild Life Society (EAWLS) kicked off a two-day Policy and Advocacy Training on Blue Carbon Ecosystems in Mombasa, bringing together over 40 stakeholders from across Kenya\'s coastal region.';
$ogUrl = 'https://dev.jumuiya.org/eawls-blue-carbon-training';
        ...
        <div class="row">
            ...
            <div class="col-lg-8 article-main">
                ...
                <div class="category-tag" data-aos="fade-up">
                    <a href="/news-updates?subcategory=Education" class="category-badge">
                        <i class="bi bi-tag"></i> Education
                    </a>
                </div>

                <!-- Article Header -->
                <header class="article-header" data-aos="fade-up">
                    <h1>EAWLS trains coastal stakeholders on Blue Carbon policy and advocacy</h1>
                ...
                <div class="featured-image" data-aos="fade-up" data-aos-delay="50">
                    <img src="/assets/images/EAWLS (4).png" alt="EAWLS Blue Carbon Policy Training in Mombasa">
                </div>
                ...
                <div class="article-content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="location-card">
                        ...
                        <div class="location-details">
                            <h4>Mombasa, Coastal Region</h4>
                            <p>Two-day Policy and Advocacy Training on Blue Carbon Ecosystems</p>
                        </div>
                    </div>
                    
                    <p class="lead">Today, EAWLS kicked off a two-day Policy and Advocacy Training on Blue Carbon Ecosystems in Mombasa, bringing together over 40 stakeholders from across Kenya's coastal region.</p>
                    
                    <p>Participants include representatives from Jumuiya ya Kaunti za Pwani, Beach Management Units (BMUs), Community Forest Associations (CFAs), Community-Based Organizations (CBOs), as well as women, youth, and persons with disabilities. Many come from communities whose voices have historically been underrepresented in national policy discourses on Blue Carbon Ecosystems.</p>
                    
                    <p>Today's sessions included interactive discussions and practical exercises to deepen participants understanding of Blue Carbon Ecosystems, including mangroves, seagrasses, and tidal marshes. They explored governance frameworks, key policies, and examined advocacy strategies to effectively engage in county and national decision-making.</p>
                    
                    <div class="info-box">
                        <p>Blue Carbon Ecosystems are vital carbon sinks that support climate mitigation, biodiversity, and coastal livelihoods, yet they continue to face growing threats due to limited awareness and gaps in policy implementation. Strengthening local capacity helps safeguard these ecosystems and ensures their value is fully recognized in national climate policies.</p>
                    </div>
                    ...
                    <div class="ecosystem-grid">
                        <div class="ecosystem-card">
                            ...
                            <h4>Mangroves</h4>
                            <p>Coastal forests that store carbon, protect shorelines, and support biodiversity</p>
                        </div>
                        <div class="ecosystem-card">
                            <div class="ecosystem-icon">
                            ...
                            <h4>Seagrasses</h4>
                            <p>Underwater meadows that capture carbon and provide nursery habitats</p>
                        </div>
                        <div class="ecosystem-card">
                            <div class="ecosystem-icon">
                            ...
                            <h4>Tidal Marshes</h4>
                            <p>Coastal wetlands that filter pollutants and sequester carbon</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 article-sidebar">
                ...
                <div class="sidebar-widget" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="prev-news-item">
                        <div class="prev-news-thumb">
                            <img src="/assets/images/fauna.jpeg" alt="Ocean Workshop">
                        </div>
                        <div class="prev-news-info">
                            <h6>Workshop on ocean governance and blue economy policy held in Mombasa</h6>
